...
public class Main {
    public static void main(String[] args) throws InterruptedException {
      // multithreading = Process of executing multiplethreads simultaneously
         //                 Helps  maximum  utilization of CPU
        //                Threads2 are independent, they dont affect the execution of other threads.
        //             An exception in one thread will not interrupt other threads
        //               useful for serving multiple clients, multplayer games, or other mutually independent tasks.

        //1. Create a subclass of Thread
         MyThread thread1 = new MyThread();                   // First way  -- limited

        // or

        //2. implement Runnable interface and pass instance as an argument to Thread()
         MyRunnable runnable1 = new MyRunnable();
        Thread thread2 = new Thread(runnable1,"");       // Second way prefferable bcus youcan extend another class
